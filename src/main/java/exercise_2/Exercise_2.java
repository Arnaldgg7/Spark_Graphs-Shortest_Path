...
public class Exercise_2 {
    ...
    private static class VProg extends AbstractFunction3<Long,Integer,Integer,Integer> implements Serializable {
        ...
        public Integer apply(Long vertexID, Integer vertexValue, Integer message) {
            if (message == Integer.MAX_VALUE) {             // superstep 0
                ...
                // Each vertex can be directly updated with the incoming message without 'if' clauses,
                // since the predicate as to send the message or not might be performed in the 'sendMsg'
                // function, taping into the existence of the Triplet. Therefore, we can figure out if
                // the destination node has a value lower (which means it represents an even shorter path)
                // or not, which gives rise not to sending the message or sending it, respectively.
                return message;
            }
        }
    }
    ...
    private static class sendMsg extends AbstractFunction1<EdgeTriplet<Integer,Integer>, Iterator<Tuple2<Object,Integer>>> implements Serializable {
        ...
        public Iterator<Tuple2<Object, Integer>> apply(EdgeTriplet<Integer, Integer> triplet) {
            ...
            if (sourceVertex._2 >= dstVertex._2) {   // source vertex value is equal or greater to dst vertex?
